...
<div class="container div-cont">
  ...
  <div class="row">
    <div class="col p-0 bg-light">
      <form class="border border-solid border-black rounded-lg p-4" onsubmit="return validate()" action="registerServlet?userId=${user.getId()}" method="post" >
        <div class="row">
        ...
        <div class="form-group">
          ...
          <button disabled type="button" class="btn btn-primary remove-address-btn">Remove</button>
          </div>
          </c:forEach>
        </div>
        ...
        <input disabled type="submit" value="Update" class="btn btn-primary w-25 mx-3" id="submit-btn" />
        </div>
      </form>
    </div>
  </div>
