...
<nav class="navbar navbar-light sticky-top font-weight-bold p-3">
    ...
    <a href="admin.jsp" class="btn btn-outline-warning d-none ml-5" id="dashboard-btn">Dashboard</a>
    <div class="mr-5" id="header-div">
    <a href="register.jsp" class="btn btn-outline-warning" id="register-btn">Register</a>
    <a href="viewServlet?userId=${admin.getId()}&role=${admin.getRole()}&adminId=${admin.getId()}" class="btn btn-outline-warning d-none" id="update-profile-btn">Edit Profile</a>
